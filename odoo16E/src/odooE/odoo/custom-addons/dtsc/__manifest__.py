# -*- coding: utf-8 -*-
{
    ...
    'depends': ['base', 'product','mrp','web','mail','sale','stock','website_sale','account','purchase','delivery','crm','note','hr_expense','hr_holidays','hr_attendance'],  # Add 'product' here
	'qweb': [
    ...
    'data': [
        ...
        'views/image_resolution_check.xml',
        ...
        'data/official_site_nav_changes.xml',
        'views/floating_line_button.xml',
	...
	'assets': {
        ...
        'web.assets_frontend': [            
            ...
            'dtsc/static/src/js/file_name_helper.js',
            'dtsc/static/src/js/public_web_order.js',
            'dtsc/static/src/js/image_resolution_check.js',
            'dtsc/static/src/js/ai_file_check.js',
            'dtsc/static/src/js/ai_member_check.js',
            'dtsc/static/src/js/checkout_view.js', 
            'dtsc/static/src/css/custom_styles.css',
            'dtsc/static/src/css/floating_line_button.css',
            'dtsc/static/src/css/image_resolution_check.css',
            'dtsc/static/src/js/website_custom.js',
            'dtsc/static/src/js/my_checkout_entry_button.js',
