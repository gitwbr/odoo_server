...
class PaymentProvider(models.Model):
    ...
    code = fields.Selection(selection_add=[('newebpay', 'NewebPay')], ondelete={'newebpay': 'set default'})

    newebpay_merchant_id = fields.Char(
        string="NewebPay Merchant ID",
        help="The Merchant ID solely used to identify your AsiaPay account.",
        required_if_provider='newebpay',
    )
    newebpay_key = fields.Char(
        string="NewebPay key",
        help="Key.",
        required_if_provider='newebpay',
    )
    newebpay_iv = fields.Char(
        string="NewebPay iv",
        help="IV.",
        required_if_provider='newebpay',
    )
