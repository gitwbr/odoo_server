...
const faqs: FAQs = {
  general: {
    ...
    questions: [
      {
        question: 'ＭegaBoard ERP 適合什麼規模的企業使用？',
        answer: '我們的系統適合各種規模的大圖輸出企業使用，從小型工作室到大型輸出廠都能靈活配置。系統模組化設計允許您根據需求選擇合適的功能。'
      },
      {
        question: '導入系統需要多長時間？',
        answer: '一般情況下，您註冊完之後可以直接創建系統進行試用，基礎系統可在幾分鐘內完成導入並開始使用。還可以升級更多功能的版本。'
      },
      {
        question: '系統是否提供培訓服務？',
  ...
  support: {
    ...
    questions: [
      {
        question: '提供哪些售後服務？',
        answer: '我們提供每日8-22時技術支援，包括電話支援、在線客服、遠程協助等。定期進行系統更新和功能優化。'
      },
      {
        question: '如何處理系統問題？',
