...
const faqs: FAQs = {
  general: {
    ...
    questions: [
      ...
      {
        question: '導入系統需要多長時間？',
        answer: '一般情況下，基礎系統可在2-4週內完成導入。具體時間取決於您的需求複雜度和自定義程度。我們會提供專業的實施顧問，確保順利導入。'
      },
      {
        question: '系統是否提供培訓服務？',
        answer: '是的，我們提供完整的培訓服務，包括系統操作培訓、管理者培訓等。培訓可以根據您的需求進行客製化安排。'
      }
    ]
  },
  technical: {
  ...
  pricing: {
    ...
    questions: [
      {
        question: '收費方式是怎樣的？',
        answer: '我們提供靈活的收費方案，包括月付和年付選項。具體價格取決於您選擇的功能模組和使用人數。'
      },
      {
        question: '是否有免費試用？',
